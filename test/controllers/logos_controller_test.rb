...
class LogosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create logo" do
    assert_difference('Logo.count') do
      post logos_url, params: { logo: { client: @logo.client, date: @logo.date, description: @logo.description, image: @logo.image, link: @logo.link, project_name: @logo.project_name } }
    end
  ...
  test "should update logo" do
    patch logo_url(@logo), params: { logo: { client: @logo.client, date: @logo.date, description: @logo.description, image: @logo.image, link: @logo.link, project_name: @logo.project_name } }
