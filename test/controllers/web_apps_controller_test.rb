...
class WebAppsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create web_app" do
    assert_difference('WebApp.count') do
      post web_apps_url, params: { web_app: { client: @web_app.client, date: @web_app.date, description: @web_app.description, image: @web_app.image, link: @web_app.link, project_name: @web_app.project_name } }
    end
  ...
  test "should update web_app" do
    patch web_app_url(@web_app), params: { web_app: { client: @web_app.client, date: @web_app.date, description: @web_app.description, image: @web_app.image, link: @web_app.link, project_name: @web_app.project_name } }
